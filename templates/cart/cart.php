 ...
 * NOTE: Function moved to main plugin file (wiwa-tour-checkout-pro.php) to prevent redeclaration errors.
 */
// function wiwa_extract_tour_meta($cart_item) { ... } -> See global function
