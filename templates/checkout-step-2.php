...
if (!isset($_POST['billing_first_name']) && !WC()->session->get('wiwa_step_1_data')) {
    wp_redirect(home_url('/checkout-wiwa/?step=1'));
    exit;
}
...
?>
<form id="wiwa-checkout-step-2" class="wiwa-checkout-form" method="post">
    <h2>Selecciona tu medio de pago</h2>
    <div class="currency-selector-section">
        <h3>Moneda</h3>
        <div class="currency-options">
            <label class="currency-option">
                <input type="radio" name="order_currency" value="COP" checked>
                <div class="currency-content"><span class="currency-flag">🇨🇴</span><span class="currency-code">COP</span></div>
            </label>
            <label class="currency-option">
                <input type="radio" name="order_currency" value="USD">
                <div class="currency-content"><span class="currency-flag">🇺🇸</span><span class="currency-code">USD</span></div>
            </label>
        </div>
    </div>
...
?>
    ...
    endforeach;
                ...
                <div class="woocommerce-info">No hay métodos de pago disponibles.</div>
            <?php
endif; ?>
        </div>
    </div>
    <div class="trust-badge">
        ...
        <span>Los pagos en <strong>wiwatour.com</strong> están encriptados y protegidos.</span>
    </div>
    <div class="form-footer">
        <a href="<?php echo esc_url(home_url('/checkout-wiwa/?step=1')); ?>" class="btn-secondary">
            <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/></svg> Volver
        </a>
        <button type="submit" class="btn-primary btn-submit" id="place_order">Confirmar y pagar</button>
    </div>
